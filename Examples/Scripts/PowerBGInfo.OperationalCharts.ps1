...
New-BGInfo -MonitorIndex 0 -Target File {
    ...
    New-BGInfoChart -Id 'ops-uptime' -Title 'Uptime' -Metric UptimeDays -Kind Circle -ValueSuffix ' days' -Width 360 -Height 140 -LineColor $purple -TextColor $white -BackgroundColor $panel -Maximum 30 -MaxPoints 1
