...
New-BGInfo -MonitorIndex 0 -Target File {
    ...
    New-BGInfoChart -Id 'patch-progress' -Title 'Patch compliance' -Kind ProgressBar -Values 96,89,74 -Labels 'Servers','Workstations','Laptops' -Width 455 -Height 210 -Anchor TopLeft -OffsetX 32 -OffsetY 32 -Palette $green,$cyan,$orange -TextColor $white -BackgroundColor $panel -ShowDataLabels -Maximum 100 -NoProgressHandles -ShowLatestValue:$false -NoHistory
...
New-BGInfo -MonitorIndex 0 -Target File {
    ...
    New-BGInfoChart -Id 'melt-compliance' -Title 'Patch compliance' -Kind ProgressBar -Values 96,89,74 -Labels 'Servers','Workstations','Laptops' -Width 480 -Height 205 -Anchor TopLeft -OffsetX 34 -OffsetY 34 -Palette $green,$cyan,$orange -TextColor $white -ShowDataLabels -Maximum 100 -NoProgressHandles -ShowLatestValue:$false -NoHistory
} -FilePath $samplePath `
    -ConfigurationDirectory $outputDir `
